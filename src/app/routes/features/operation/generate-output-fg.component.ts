...
@Component({
    selector: 'batch-fg-generate',
    templateUrl: 'generate-output-fg.component.html',
    styleUrls: ['./generate-output-fg.component.scss']
})
export class GenerateOutputFGBatchComponent {
    ...
    constructor(private _bapiService: BapiService, private _fetchService: FetchService,
        ...
        this._routeService.events.pipe(
            ...
            this._titleService.setTitle(`成品序列号生成`);
        });
    }
